          ...
          <div className="customerInfo">
            ...
            <div className="metaInfo">
              ...
              <div className={`balance ${isNegative ? 'negative' : ''}`}>
                ...
                <span className="balanceLabel">{isNegative ? ' owed' : ' credit'}</span>
            ...
            <div className="transactionButtons">
              ...
              <button
                ...
                className={`transButton credit ${
                  ...
                  selectedCustomerIndex === index && transactionType === 'credit' ? 'active' : ''
              ...
              <button
                ...
                className={`transButton debit ${
                  ...
                  selectedCustomerIndex === index && transactionType === 'debit' ? 'active' : ''
      ...
      <main className="mainContent">
        ...
        <div className="listContainer">
          ...
          {filteredLedgerData.length > 0 ? (
            ...
            filteredLedgerData.map((item, index) => renderLedgerItem(item, index))
