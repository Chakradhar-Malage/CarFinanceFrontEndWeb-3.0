    ...
    <div className=' m-2 p-2'>
      <div className='flex items-center justify-between'>
        <div className='flex items-center p-4 '>
            <Image className='border border-3 rounded-lg' src="/webbuild/images/usericon.png" alt="User Icon" width={50} height={50} />
        ...
        <button onClick={() => console.log('Logout')}>
          <Image style={styles.logoutimg} src="/webbuild/images/Logout.png" alt="Logout" width={25} height={25} />
        </button>
