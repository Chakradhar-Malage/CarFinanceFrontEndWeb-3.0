    ...
    const fetchVehicleDetails = async () => {
      ...
      try {
        ...
        const response = await fetch(
          ...
          `http://15.207.48.53:3000/searchById?id=${encodeURIComponent(vehicleId)}`
    ...
    <div className="main-container">
      ...
      <div className="header">
        ...
        <div className="user-container">
          ...
          <Image src="/webbuild/images/usericon.png" alt="User Icon" width={50} height={50} className="usrimg" />
        ...
        <Image src="/webbuild/images/Logout.png" alt="logout" width={25} height={25} className="logoutimg" />
      ...
      <div className="section-header">
        ...
        <Image src="/webbuild/images/Car.png" alt="Car" width={25} height={25} className="icon" />
      ...
      <div className="form-group">
        ...
        <input className="input" value={vehicleDetails.name_of_vehicle} readOnly />
      ...
      <div className="form-group">
        ...
        <input className="input" value={issued_to} onChange={(e) => setIssuedTo(e.target.value)} placeholder="Event/Person Name" />
      ...
      <div className="form-group">
        ...
        <input className="input" value={agreed_amount} onChange={(e) => setAgreedAmount(e.target.value)} type="number" placeholder={vehicleDetails.agreed_amount.toString()} />
      ...
      <div className="form-group">
        ...
        <input className="input" value={received_amount} onChange={(e) => setReceivedAmount(e.target.value)} type="number" placeholder={vehicleDetails.received_amount.toString()} />
      ...
      <div className="date-group">
        ...
        <input className="date-input" value={date} onChange={(e) => setDate(e.target.value)} placeholder={vehicleDetails.date} />
      ...
      <div className="form-group">
        ...
        <input className="input" value={driver_expense} onChange={(e) => setDriverExpense(e.target.value)} type="number" placeholder={vehicleDetails.driver_expense.toString()} />
      ...
      <div className="form-group">
        ...
        <input className="input" value={fuel_expense} onChange={(e) => setFuelExpense(e.target.value)} type="number" placeholder={vehicleDetails.fuel_expense.toString()} />
      ...
      <div className="form-group">
        ...
        <input className="input" value={maintenance} onChange={(e) => setMaintenance(e.target.value)} type="number" placeholder={vehicleDetails.maintenance.toString()} />

      </div>


      <p className="pending-amount">Pending Amount: Rs.{calculatePendingAmount()}</p>
      ...
      <div className="button-group">
        ...
        <button className="clear-button" onClick={() => setShowClearOptions(true)}>
      ...
      {showClearOptions && (
        ...
        <div className="clear-options">
          ...
          <div className="option-buttons">
            ...
            <button className="option-button" onClick={handleClearPendingPayment}>

              Pending Payment

            </button>

            <button className="option-button cancel-button" onClick={handleCancelClear}>
