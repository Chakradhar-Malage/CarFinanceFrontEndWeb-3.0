        ...
        >
          ...
          <div className="totalsContainer">
            ...
            <p className="totalsText">
              ...
              Total Agreed Amount: Rs. {carDetails.totalAgreedAmount?.toFixed(2)}
                ...
                <tbody>
                  ...
                  {selectedCarRecords.map((item, index) => (
                    ...
                    <tr key={index} className="tableRow">
                      ...
                      <td style={{minWidth: 120}}>{moment(item.cleared_at).format('DD-MM-YYYY')}</td>

                      <td style={{ textAlign: 'left' }}>{item.issued_to}</td>

                      <td style={{ textAlign: 'left' }}>Rs.{item.agreed_amount}</td>

                      <td style={{ textAlign: 'left' }}>Rs.{item.total_expenses}</td>

                      <td style={{ textAlign: 'left' }}>

                        Rs.{(item.agreed_amount - item.total_expenses).toFixed(2)}
